...
throws_ok {RE Number => "decimal", -base => 0}
          qr /^-base must be an unsigned integer between 1 and 36 inclusive/,
          "Croaks on zero -base";

throws_ok {RE Number => "decimal", -base => -5}
          qr /^-base must be an unsigned integer between 1 and 36 inclusive/,
          "Croaks on negative -base";

throws_ok {RE Number => "decimal", -base => 37}
          qr /^-base must be an unsigned integer between 1 and 36 inclusive/,
          "Croaks on -base exceeding 36";

throws_ok {RE Number => "decimal", -base => ' '}
          qr /^-base must be an unsigned integer between 1 and 36 inclusive/,
          "Croaks on -base not a number";

throws_ok {RE Number => "decimal", -base => '8', -case => 'foo'}
